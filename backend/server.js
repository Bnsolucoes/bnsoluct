...
const allowedOrigins = [
  'http://localhost:3000',
  'https://site-project-eight.vercel.app' // altere para o seu domínio real da Vercel
];
...
app.put('/api/leads/:id', (req, res) => {
  try {
    ...
    leads[idx] = { ...leads[idx], status, observacoes, data_atualizacao: new Date().toISOString() };
